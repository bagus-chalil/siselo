                                ...
                                <?php $i =1;?>
                                        <?php foreach ($role as $r) :?>
                                            <tr>
                                                ...
                                                <a class="btn waves-effect waves-light btn-warning text-white" href="<?= base_url('user/roleAccess/' .$r['id']) ?>"> <i class="fa fa-pencil-alt"></i> Role Access</a>
                                                <a class="btn waves-effect waves-light btn-danger text-white" href="<?= base_url('user/delete_role/' .$r['id']) ?>"> <i class="fa fa-trash"></i> Delete</a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                </tbody>
